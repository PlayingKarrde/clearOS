...
[Download the latest version](https://github.com/PlayingKarrde/clearOS/releases/latest) and extract it in your [Pegasus theme directory](http://pegasus-frontend.org/docs/user-guide/installing-themes/) under a folder called clearOS.
